...
export default class Dashboard extends Component {
    ...
    loadUsers = async (actualPage = 1) => {
        const responseUser = await api.get(`/users?page=${actualPage}`, { headers: { "Authorization": this.state.accessToken } });
        ...
        this.setState({ users: docs, page: actualPage, pages, paginate: true });
    };
    ...
    handleRemove = async () => {
        ...
        const responseUser = await api.delete(`/users/${this.state.deleteId}`, { headers: { "Authorization": this.state.accessToken } });
                        ...
                        <Row>
                            <Col sm={10}>
                                <InputGroup className="margin-bot">
                                    <FormControl name="search" placeholder="Search by name" onKeyDown={this.handleSearch} onChange={this.handleInputChange} />
                                </InputGroup>
                            </Col>
                            <Col sm={2}>
